...
if($num==1)
{
	...
	echo '<script>alert("username already taken")</script>';
		?>
	<META HTTP-EQUIV="Refresh" CONTENT="0; URL=https://localhost/hms-hospital/signup.html">
      <?php
}
else
{
	...
	?>
	<META HTTP-EQUIV="Refresh" CONTENT="0; URL=https://localhost/hms-hospital/signin.html">
      <?php
}
}
